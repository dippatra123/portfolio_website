        ...
        <div className="projects-grid">
          ...
          <div className="experience-card">
            ...
            <div className="experience-content">
              ...
              <span className="experience-date">Your Start Date – Present</span>

              <p>
                Working on full-stack web applications, developing responsive
                frontend interfaces, backend APIs, database integrations, and
              ...
              <ul>
                <li>
                  ...
                  JavaScript, Bootstrap and Tailwind CSS.
                </li>

                <li>Built REST APIs using Node.js and Express.js.</li>

                <li>
                  Worked with MySQL for database management and application
                  data.
                </li>

                <li>
                  Implemented authentication using JWT, sessions and cookies.
                </li>

                <li>
                  Worked on AI-powered data extraction and JSON conversion
                  features.
                </li>

                <li>
                  Developed stock management, reconciliation and Excel report
                  generation features.
                </li>
              </ul>
            </div>
